...
const DialogListEquipmentGeneraux = ({
  openthree,
  handleClosethree,
  region,
  province,
    ...
    const fetchData = async () => {
      try {
        const params = new URLSearchParams({
          categorie: "équipement généreaux",
          region: region || "",
          province: province || "",
          startDate: startDate || "",
          endDate: endDate || "",
        ...
        const dispositifMedicaux =
          result.nonClosedByNeedAndCategory?.["équipement généreaux"] || [];
  ...
  }, [region, province, startDate, endDate, openthree]);
  return (
    <>
      {" "}
      <Dialog
...
export default DialogListEquipmentGeneraux;
