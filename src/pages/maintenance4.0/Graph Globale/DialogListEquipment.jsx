...
const DialogListEquipment = ({
    ...
    const fetchData = async () => {
      try {
        ...
        const dispositifMedicaux =
          result.nonClosedByNeedAndCategory?.["Dispositif Médicaux"] || [];
  ...
  }, [region, province, startDate, endDate, open]);
...
export default DialogListEquipment;
